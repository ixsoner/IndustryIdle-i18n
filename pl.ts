export const PL = {
    Translator: "Tłumacz",
    TranslatorName: "Wpisz Swoje Imię!",
    Language: "Język",
    ThisLanguage: "Polski",
    OK: "OK",
    ...
    FuelProduction: "%{Paliwa} Produkcja",
    ...
    Multiplier: "Mnożnik",
    MultiplierDesc: "Co 10 poziomów dostajesz +1 mnożnika",
    SellBuilding: "Sprzedaj Budynek",
    PowerGrid: "Power Grid",
    TradeAmount: "Ilość wymiany",
    SortBy: "Sortuj Przez",
    SortByPrice: "Cenę",
    SortByAmount: "Ilość",
    NotEnoughResourcesForTrade: "Nie wystarczająca liczba zasobów w Centrum Wymian, na tą wymianę.",
    NotEnoughResources: "Nie wystarczająca liczba materiałów na ta operacje.",
    Transportation: "Transportation",
    Cash: "Pieniądze",
    Aluminum: "Aluminium",
    ResearchPoint: "Punkt Nauki*",
    Unlock: "Odblokuj",
    BuildingUnlocked: "%{budynek} został odblokowany.",
    Science: "Nauka",
    ScienceFromPowerDesc: "Elektrownie pordukują małą ilość nauki kiedy generują energię.",
    Culture: "Kultura",
    School: "Szkoła",
    University: "Uniwersytet",
    Polytechnic: "Politechinka",
    Colosseum: "Kolloseum",
    WindTurbine: "Wiatrak",
    Engine: "Silnik",
    EngineFactory: "Fabryka Silników",
    CameraFactory: "Fabryka Kamer",
    Camera: "Kamera",
    Gun: "Karabin",
    GunFactory: "Fabryka Karabinów",
    Aircraft: "Lotniskowiec",
    AircraftFactory: "Fabryka Lotniskowców",
    Zeppelin: "Sterowiec",
    ZeppelinFactory: "Fabryka Sterowców",
    Tank: "Czołg",
    TankFactory: "Fabryka Czołgów",
    CoalPowerPlant: "Elektrownia Węglowa",
    PetrolPowerPlant: "Elektrownia na Benzynę",
    Copper: "Miedź",
    Gas: "Gaz Ziemny",
    ...
    BuildingPermit: "Zezwolenie Budowlane",
    BuildingPermitDesc:
    ...
    BuildQueueDesc: "Liczba budynków w kolejce.",
    MaxBuilders: "Maxsymalna liczba budowniczych.",
    MaxBuildersDesc: "Liczba budynków, którą możesz budować naraz.",
    Silicon: "Silikon",
    AluminumMine: "Kopalnia Aluminium",
    CopperMine: "Kopalnia Miedzi",
    SiliconMine: "Kopalnia Silikonu",
    IronMine: "Kopalnia Żelaza",
    CoalMine: "Kopalnia Węgla",
    Headquarter: "Siedziwa Główna",
    ResearchLab: "Research Lab",
    TradeCenter: "Centrum Wymian.*",
    Resources: "Zasoby",
    NotEnoughPower: "💡 Niewystarczająca ilość energi, rozważ zwiększenie ilości produkowanej energi.",
    NotEnoughFuel: "Niewystarczająca ilość %{fuel} na tą operacje ",
    NotEnoughCash: "Niewystarczająca ilość pieniędzy na tą operację.",
    NotEnoughSwissMoney: "Niewystarczająca ilość szwajcarskich pieniędzy, na tą operację.Not enough Swiss Money, for this operation",
    BuildingNotEnoughFuel: "💡 Niewystarczająca ilość %{fuel}",
    AutoSell: "Sprzedaj Automatycznie",
    ...
    Coal: "Węgiel",
    Video: "Nagranie",
    ClothingFactory: "Fabryka Ubrań",
    Clothes: "Ubrania",
    Fashion: "Moda",
    FashionFactory: "Fabryka Mody*",
    VideoFarm: "Studio Nagrań",
    ...
    GetHelp: "Get Help",
    GetHelpBeginnerGuides: "Poradnika dla początkujących",
    GetHelpSteamGuides: "Inne poradinki Steam",
    GetHelpInGameChat: "Zapytaj czat w grze",
    GetHelpDiscord: "Dołącz do naszego Discorda",
